...
0.3-4   & 2025-04-20     & issue with $\backslash$\texttt{link} in rd-files fixed \\ \midrule
0.3-3   & 2020-02-08     & issue with vignette fixed \\ \midrule
0.3-2   & 2020-01-13     & issue with hidden slider control fixed \\
        &                & minor changes in default layout parameters for the control panel \\
        &                & update of references \\ \midrule
0.3-1   & 2015-04-22     & update of contact details \\ \midrule
0.3-0   & 2014-11-12     & switch to the concept of generic functions \\
...
0.2-2   & 2014-09-08     & vignette revised \\\midrule
0.2-1   & 2014-08-26     & argument \texttt{preselect.groups} added          \\
...
0.1-3   & 2014-08-18     & first published version                           \\ \bottomrule
\end{tabular} 
\end{table}
\pagebreak
